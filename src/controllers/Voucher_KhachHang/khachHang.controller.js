...
module.exports = {
    ...
    nhanThuong: async (req, res) => {
        try {
            ...
            // Kiểm tra nếu voucher đã tồn tại trong tài khoản người dùng
            const voucherExists = user.IdVoucher.some(voucher => voucher.toString() === voucherId.toString());
            ...
            if (voucherExists) {
                ...
                user.IdVoucher.push(voucherId);
                await user.save();  // Lưu lại thông tin người dùng với voucher mới
