...
module.exports = {
    ...
    createVoucher: async (req, res) => {
        try {
            let {code, dieuKien, giamGia, thoiGianHetHan, moTa} = req.body                       

            let createTL = await Voucher.create({code, dieuKien, giamGia, thoiGianHetHan, moTa})
    ...
    updateVoucher: async (req, res) => {
        try {
            let {_id, code, dieuKien, giamGia, thoiGianHetHan, moTa} = req.body

            let updateTL = await Voucher.updateOne({_id: _id},{code, dieuKien, giamGia, thoiGianHetHan, moTa})
